...
df_new.loc['Andre'] = df_new.loc[['Totalt']].sum(skipna=True)-df_new.loc[['Association of Local Authorities', 'The Enterprise Federation of Norway','The Confederation of Norwegian Enterprise (NHO), total', "The Employers' Association Spekter"]].sum(skipna=True)
...
df2_new.loc['Andre'] = df2_new.loc[['Totalt']].sum(skipna=True)-df2_new.loc[['Association of Local Authorities', 'The Enterprise Federation of Norway','The Confederation of Norwegian Enterprise (NHO), total', "The Employers' Association Spekter"]].sum(skipna=True)
...
df_new.loc['Others'] = df_new.loc[['Total']].sum(skipna=True)-df_new.loc[['Association of Local Authorities', 'The Enterprise Federation of Norway','The Confederation of Norwegian Enterprise (NHO), total', "The Employers' Association Spekter"]].sum(skipna=True)
df_new2=df_new.loc[["The Employers' Association Spekter",'Association of Local Authorities','The Enterprise Federation of Norway','The Confederation of Norwegian Enterprise (NHO), total','Others'],:]
