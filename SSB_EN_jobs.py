...
date_string3 = 'Seasonally adjusted data for ' + date_string2.strftime ('%B %Y') + '.'
date_string4 = 'Seasonally adjusted data for ' + date_string2.strftime ('%B %Y') + '.'
date_string5 = 'Seasonally adjusted data for ' + date_string2.strftime ('%B %Y')
json_object = json.loads(result.text)
raw_date = json_object["updated"]
parsed_date = datetime.strptime(raw_date, '%Y-%m-%dT%H:%M:%SZ')
chart_date = 'Data last published: ' + parsed_date.strftime ('%d/%m/%y')
...
date_string = title_date.replace("M","")
date_string2 = datetime.strptime(date_string, "%Y%m")
date_string3 = 'Seasonally adjusted numbers for ' + date_string2.strftime ('%B %Y') + ' compared with same month previous year.'
json_object = json.loads(result.text)
raw_date = json_object["updated"]
parsed_date = datetime.strptime(raw_date, '%Y-%m-%dT%H:%M:%SZ')
chart_date = 'Data last published: ' + parsed_date.strftime ('%d/%m/%y')
