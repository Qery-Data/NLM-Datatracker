...
forecasts = {
    ...
    'Norges Bank': [2.0,2.2,2.3,pd.NA],
    'FIN': [2.0,2.1,pd.NA,pd.NA],
    'NHO': [2.5,2.5,2.4,pd.NA],
    'DNB': [2.4,2.8,2.8,pd.NA],
