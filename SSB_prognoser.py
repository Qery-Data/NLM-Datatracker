...
forecasts = {
    ...
    'DNB': [1.8,2.1,2.6,3.0],
    'Danske Bank': [1.8,2.4,pd.NA,pd.NA],
...
forecasts = {
    ...
    'LO':[3.3,0.0,0.0,-0.2],
    'DNB': [2.7,0.1,0.1,0.0],
    'Danske Bank': [3.6,0.3,pd.NA,pd.NA],
...
forecasts = {
    ...
    'NHO': [3.3,3.9,2.9,pd.NA],
    'LO':[5.5,3.5,1.9,2.1],
    'Danske Bank': [5.5,3.4,pd.NA,pd.NA],
    'DNB': [5.3,4.0,2.7,2.7],
    'Handelsbanken': [5.5,3.7,2.0,pd.NA],
    'Nordea': [5.5,3.8,2.5,pd.NA],
    'SEB': [5.8,4.7,2.2,pd.NA],
