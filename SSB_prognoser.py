...
forecasts = {
    'NAV': [1.8,2.0,2.2,pd.NA],
    'Norges Bank': [1.8,2.0,2.2,2.3],
...
df_new.loc[df_new.index[0:7],'SSB'] = pd.NA
forecasts = {
    'Norges Bank': [1.3,0.4,0.4,0.6],
    'FIN': [1.3,0.1,0.5,pd.NA],
    'NAV': [0.9,0.3,0.2,pd.NA],
...
df_new.loc[df_new.index[0:7],'SSB'] = pd.NA
forecasts = {
    'Norges Bank': [1.1,0.5,1.2,1.3],
    'FIN': [0.6,0.8,1.9,pd.NA],
    'NAV': [0.7,1.0,1.5,pd.NA],
