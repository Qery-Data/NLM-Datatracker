...
df_new.to_csv('data_EN/OECD_Annual_Working_Time.csv', index=True)
df_new_no = df.pivot(index='TIME_PERIOD', columns='REF_AREA', values='OBS_VALUE')
df_new_no.index.rename("TIME", inplace=True)
df_new_no = df_new_no.rename(columns=rename_columns_no)
...
result = requests.get(oecd_url, headers={'Accept': 'text/csv'})
df=pd.read_csv(io.StringIO(result.text))
df_new = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE').round(1)
df_new = df_new.rename(index=rename_columns)
df_new['2000-2007'] = df_new.loc[:, 2000:2007].mean(axis=1).round(1)
df_new['2010-2022'] = df_new.loc[:, 2010:2022].mean(axis=1).round(1)
df_new.to_csv('data_EN/OECD_Productivity_Growth_Rates.csv', index=True)
df_new_no = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new_no['2000-2007'] = df_new_no.loc[:, 2000:2007].mean(axis=1).round(1)
df_new_no['2010-2022'] = df_new_no.loc[:, 2010:2022].mean(axis=1).round(1)
df_new_no = df_new_no.rename(index=rename_columns_no)
...
df_new = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new = df_new.rename(index=rename_columns)
df_new.to_csv('data_EN/OECD_Employment_Rate.csv', index=True)
df_new_no = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new_no = df_new_no.rename(index=rename_columns_no)
...
df_new = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new = df_new.rename(index=rename_columns)
df_new.to_csv('data_EN/OECD_Employment_Rate_Men.csv', index=True)
df_new_no = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new_no = df_new_no.rename(index=rename_columns_no)
...
df_new = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new = df_new.rename(index=rename_columns)
df_new.to_csv('data_EN/OECD_Employment_Rate_Women.csv', index=True)
df_new_no = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new_no = df_new_no.rename(index=rename_columns_no)
...
df_new = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new = df_new.rename(index=rename_columns)
df_new.to_csv('data_EN/OECD_Trade_Union_Density.csv', index=True)
df_new_no = df.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
df_new_no = df_new_no.rename(index=rename_columns_no)
df_new_no.to_csv('data/OECD_Organisasjonsgrad.csv', index=True)
