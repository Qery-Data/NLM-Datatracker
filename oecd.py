...
df_index.insert(8, 'Fastlands-Norge',[100,103,105.8,109.8,113.3,117.3,119.4,120.6,119.3,119,120.9,120.9,123.3,125.8,126.8,127.5,127.6,129.6,130.5,131.3,130.8,0], True)
...
df=pd.read_csv(io.StringIO(result.text))
df_new = df.pivot(index='Time', columns='Country', values='Value')
df_new.insert(8, 'Fastlands-Norge',[127.5,127.6,129.6,130.5,131.3,130.8,0], True)
df_index = df_new.div(df_new.iloc[0]).mul(100)
